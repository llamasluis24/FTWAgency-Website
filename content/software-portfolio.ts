...
export const softwarePortfolioProjects: SoftwareProject[] = [
  ...
  },
  {
    ...
    category: "Revenue / Stripe Companion",
    highlightTag: "Multi-Account SaaS Product",
    description:
      "A Stripe companion that unifies payments, invoices, subscriptions, refunds, and alerts across every connected account — with Insights, Home Screen widgets, and Sales Watch.",
    features: [
      "Unified Multi-Account Feed",
      "Account Attribution",
      "Today Revenue Insights",
      "Alerts & Notifications",
      "Sales Watch Live Activity",
      "Home Screen Widgets",
      "Stripe OAuth Connect",
    ],
    preview: "crm",
    accent: "amber",
    heroImage: "/showcases/software/sales-goblin-hero.jpg",
    heroImageAlt: "Sales Goblin homepage — every Stripe account, every sale, one feed",
  },
  {
    slug: "wpconvert-ai",
    name: "WP Convert AI",
