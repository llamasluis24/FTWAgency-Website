...
const GbpVisualDemonstration = dynamic(
  () =>
    import("@/components/gbp/GbpVisualDemonstration").then(
      (m) => m.GbpVisualDemonstration,
    ),
  { loading: () => <div className="min-h-[800px] bg-surface" aria-hidden /> },
);

export async function generateMetadata(): Promise<Metadata> {
  const service = getService("google-business-profile");
  if (!service) return {};
