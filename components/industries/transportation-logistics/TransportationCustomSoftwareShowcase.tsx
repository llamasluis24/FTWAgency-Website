...
import type { transportationLogisticsCustomSoftwareModules } from "@/content/industries/modules/transportation-logistics-custom-software-modules";

export function TransportationCustomSoftwareShowcase({
  content,
}: {
  content: typeof transportationLogisticsCustomSoftwareModules.showcase;
}) {
  return (
    <Section surface>
      <Container>
