...
import type { StartupsSocialModules } from "@/content/industries/modules/startups-social-modules";
import { cn } from "@/lib/utils";

export function StartupsSocialShowcase({
  content,
}: {
  content: StartupsSocialModules["showcase"];
}) {
        ...
        <div className="mb-6 flex flex-wrap justify-center gap-2">
          {(
            [
              ...
              { id: "shoot" as const, label: "Founder Shoot", icon: Clapperboard },
              { id: "profile" as const, label: "Launch Profile", icon: Smartphone },
            ] as const
