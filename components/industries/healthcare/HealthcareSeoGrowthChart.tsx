...
import type { healthcareSeoModules } from "@/content/industries/modules/healthcare-seo-modules";

export function HealthcareSeoGrowthChart({
  content,
}: {
  content: typeof healthcareSeoModules.growth;
}) {
  return (
    <Section>
      <Container>
            ...
            <div className="border-b border-white/10 bg-elevated px-4 py-3">
              <div className="flex items-center gap-2">
                ...
                <span className="mx-auto text-[10px] text-muted">
                  analytics.lakesidedentalstudio.com
                </span>
              </div>
            </div>
