...
export function RetailEcommerceSocialShowcase({
  content,
}: {
  content: RetailEcommerceSocialModules["showcase"];
}) {
        ...
        <div className="mb-6 flex flex-wrap justify-center gap-2">
          {(
            [
              ...
              { id: "shoot" as const, label: "Product Shoot", icon: Clapperboard },
              { id: "profile" as const, label: "Shop Profile", icon: Smartphone },
            ] as const
