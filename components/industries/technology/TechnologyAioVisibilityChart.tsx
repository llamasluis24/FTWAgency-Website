...
function TrendChart({
  ...
  const gradId = `aio-tech-${label.replace(/\s+/g, "-").toLowerCase()}`;
...
export function TechnologyAioVisibilityChart({
  content,
}: {
  content: TechnologyAioModules["visibility"];
}) {
  return (
    <Section>
      <Container>
