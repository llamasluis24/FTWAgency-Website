...
import type { constructionSeoModules } from "@/content/industries/modules/construction-seo-modules";

export function ConstructionSeoGrowthChart({
  content,
}: {
  content: typeof constructionSeoModules.growth;
}) {
  return (
    <Section>
      <Container>
          ...
          <div className="mx-auto max-w-2xl overflow-hidden rounded-2xl border border-white/10 bg-bg shadow-[0_0_48px_rgba(0,212,255,0.08)]">
            <div className="border-b border-white/10 bg-elevated px-4 py-3">
              <div className="flex items-center gap-2">
                ...
                <span className="mx-auto text-[10px] text-muted">analytics.northgatedesignbuild.com</span>
              </div>
            </div>
