...
import type { manufacturingSeoModules } from "@/content/industries/modules/manufacturing-seo-modules";

export function ManufacturingSeoGrowthChart({
  content,
}: {
  content: typeof manufacturingSeoModules.growth;
}) {
  return (
    <Section>
      <Container>
