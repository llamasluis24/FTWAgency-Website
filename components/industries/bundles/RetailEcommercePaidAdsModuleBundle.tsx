...
import { retailEcommercePaidAdsModules } from "@/content/industries/modules/retail-ecommerce-paid-ads-modules";
...
export function RetailEcommercePaidAdsModuleBundle() {
  const modules = retailEcommercePaidAdsModules;
  return (
    <>
