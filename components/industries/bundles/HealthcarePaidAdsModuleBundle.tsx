...
import { healthcarePaidAdsModules } from "@/content/industries/modules/healthcare-paid-ads-modules";
...
export function HealthcarePaidAdsModuleBundle() {
  const modules = healthcarePaidAdsModules;
  return (
    <>
