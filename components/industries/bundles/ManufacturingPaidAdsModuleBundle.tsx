...
import { manufacturingPaidAdsModules } from "@/content/industries/modules/manufacturing-paid-ads-modules";
...
export function ManufacturingPaidAdsModuleBundle() {
  const modules = manufacturingPaidAdsModules;
  return (
    <>
