...
import type { homeServicesGbpModules } from "@/content/industries/modules/home-services-gbp-modules";
import { cn } from "@/lib/utils";

type ShowcaseContent = typeof homeServicesGbpModules.showcase;

export function HomeServicesGbpShowcase({ content }: { content: ShowcaseContent }) {
          ...
          <div ref={ref} className="grid items-start gap-8 lg:grid-cols-2 lg:gap-12">
            ...
            >
              ...
              <p className="mt-6 text-sm text-muted">
                Optimized categories, review velocity, and activity signals compound map pack
