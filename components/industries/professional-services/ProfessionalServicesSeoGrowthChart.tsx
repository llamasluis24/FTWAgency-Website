...
import type { professionalServicesSeoModules } from "@/content/industries/modules/professional-services-seo-modules";

export function ProfessionalServicesSeoGrowthChart({
  content,
}: {
  content: typeof professionalServicesSeoModules.growth;
}) {
  return (
    <Section>
      <Container>
          ...
          <div className="mx-auto max-w-2xl overflow-hidden rounded-2xl border border-white/10 bg-bg shadow-[0_0_48px_rgba(0,212,255,0.08)]">
            <div className="border-b border-white/10 bg-elevated px-4 py-3">
              <div className="flex items-center gap-2">
                ...
                <span className="mx-auto text-[10px] text-muted">
                  analytics.meridianlawgroup.com
                </span>
              </div>
            </div>
