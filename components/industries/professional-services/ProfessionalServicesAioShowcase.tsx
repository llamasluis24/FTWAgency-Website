        ...
        {slide.whyAppeared && (
          <div className="mt-4 rounded-lg border border-emerald-200 bg-emerald-50 p-3">
            <p className="mb-2 text-xs font-semibold text-emerald-700">
              Why{" "}
              {slide.recommendations.find((rec) => rec.highlight)?.name ?? "This Firm"} Appeared
            </p>
...
export function ProfessionalServicesAioShowcase({
  content,
}: {
  content: ProfessionalServicesAioModules["showcase"];
}) {
