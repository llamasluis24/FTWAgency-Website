...
export function RestaurantsHospitalitySocialShowcase({
  content,
}: {
  content: RestaurantsHospitalitySocialModules["showcase"];
}) {
        ...
        <div className="mb-6 flex flex-wrap justify-center gap-2">
          {(
            [
              ...
              { id: "shoot" as const, label: "Food Shoot", icon: Clapperboard },
              { id: "profile" as const, label: "Restaurant Profile", icon: Smartphone },
            ] as const
          ...
          <div className="relative border-b border-white/10 bg-elevated px-4 py-3">
            <div className="flex items-center gap-2">
              ...
              <span className="mx-auto rounded-md bg-white/5 px-4 py-1 text-[10px] text-muted">
                farmhousecollective.com · content studio
              </span>
            </div>
          </div>
            ...
            >
              ...
              {activePanel === "profile" && (
                <ProfileConvertMock
                  ...
                  imageWidth={content.profileImageWidth}
                  imageHeight={content.profileImageHeight}
                />
              )}
            </motion.div>
          </div>
